								...
								<div class="single-product">
									<div class="product-img">
										<a href="<?php echo base_url('produk/detail/'.$produk->slug_produk) ?>">
											<img class="default-img" src="<?php echo base_url('assets/upload/image/thumbs/'.$produk->gambar) ?>" alt="<?php echo $produk->nama_produk ?>">
											<img class="hover-img" src="<?php echo base_url('assets/upload/image/thumbs/'.$produk->gambar) ?>" alt="<?php echo $produk->nama_produk ?>">
										</a>
