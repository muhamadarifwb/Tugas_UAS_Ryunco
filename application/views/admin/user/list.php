    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="<?php echo base_url('admin/user/delete/'.$user->id_user) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin Ingin menghapus Data ini ?')"><i class="fa fa-trash-alt"></i> Delete</a>
            </td>
        </tr>
        <?php } ?>
    </tbody>
