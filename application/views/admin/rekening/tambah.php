...
<div class="form-group row">
    ...
    <div class="form-group row">
    <label class="col-md-2 col-form-label">Nomor Pemilik Rekening (Atas Nama)</label>
    <div class="col-md-5">
        <input type="text" name="nama_pemilik" class="form-control" placeholder="Nomor Pemilik Rekening" value="<?php echo set_value('nama_pemilik') ?>" required>
    </div>
    </div>
